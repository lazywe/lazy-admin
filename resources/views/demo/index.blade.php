...
@push('scripts')
    ...
    <script src="{{ lazy_asset('js/plugins/easypiechart/jquery.easypiechart.js')}}"></script>
    <script src="{{ lazy_asset('js/plugins/sparkline/jquery.sparkline.min.js')}}"></script>
    <script src="{{ lazy_asset('js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js')}}"></script>
    <script src="{{ lazy_asset('js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js')}}"></script>
    <script src="{{ lazy_asset('js/plugins/jquery-ui/jquery-ui.min.js')}}"></script>
    <script src="{{ lazy_asset('js/plugins/flot/jquery.flot.js')}}"></script>
    <script src="{{ lazy_asset('js/plugins/flot/jquery.flot.tooltip.min.js')}}"></script>
    <script src="{{ lazy_asset('js/plugins/flot/jquery.flot.spline.js')}}"></script>
    <script src="{{ lazy_asset('js/plugins/flot/jquery.flot.resize.js')}}"></script>
    <script src="{{ lazy_asset('js/plugins/flot/jquery.flot.pie.js')}}"></script>
    <script src="{{ lazy_asset('js/plugins/flot/jquery.flot.symbol.js')}}"></script>

    <script>
        $(function(){
            set_active_menu("{{md5(route('lazy-admin.demo.index'))}}")
