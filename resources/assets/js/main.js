 ...
 */
 $(function () {
	 ...
	 * @param function completeCallback 完成函数
     */
    $.ajaxRequest = function (url, data, method, callback, completeCallback) {
        // 防止多次操作ajax
	 ...
	 * @param function completeCallback 完成函数
	 */
    $.ajaxUploadRequest = function (url, data, method, callback, completeCallback) {
